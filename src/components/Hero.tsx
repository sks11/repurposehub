  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden hero-gradient">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-20 text-center">
        ...
        >
          <div className="rounded-2xl border border-border/80 shadow-2xl shadow-primary/5 overflow-hidden bg-white">
            {/* Browser bar */}
            <div className="flex items-center gap-2 px-4 py-3 bg-surface border-b border-border">
              ...
              <div className="flex-1 mx-4">
                <div className="bg-white rounded-lg px-4 py-1.5 text-xs text-muted text-center max-w-md mx-auto border border-border/60">
                  app.repurposehub.co
                </div>
              </div>
            </div>
            ...
            <div className="p-6 sm:p-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <div className="text-sm font-semibold text-foreground">Your Content</div>
                <div className="bg-surface rounded-xl p-5 border border-border min-h-[200px]">
                  <p className="text-sm text-muted leading-relaxed">
                    Today I want to share 5 lessons I learned after growing my
                    coaching business from $0 to $50K/month in 18 months. The
                    biggest surprise? It wasn&apos;t about finding more clients — it
                    was about serving fewer clients better...
                  </p>
                </div>
                ...
                <button className="w-full py-3 rounded-xl bg-gradient-to-r from-primary to-accent text-white text-sm font-semibold hover:shadow-lg transition-all">
                  Repurpose Content &rarr;
                </button>
              </div>
              {/* Output side */}
              <div className="space-y-3">
                <div className="text-sm font-semibold text-foreground">Generated Content</div>
                <div className="space-y-2">
                  {[
                    {
                      platform: "Twitter/X",
                      badge: "badge-twitter",
                      text: "5 lessons from $0 → $50K/month coaching biz:\n\n1. Fewer clients, deeper impact\n2. Systems > hustle\n3. Your story IS the strategy\n\nThread below",
                    },
                    {
                      platform: "LinkedIn",
                      badge: "badge-linkedin",
                      text: "18 months ago I had zero revenue. Today, $50K/month.\n\nThe counterintuitive lesson? I stopped chasing more clients...",
                    },
                    {
                      platform: "Instagram",
                    ...
                    <div
                      key={item.platform}
                      className="bg-surface rounded-xl p-4 border border-border group hover:border-primary/20 transition-colors"
                    >
                      <div className="flex items-center justify-between mb-2">
                        <span className={`px-2.5 py-1 rounded-lg text-xs font-medium ${item.badge}`}>
                          {item.platform}
                        </span>
                        <span className="text-xs text-primary opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer font-medium">
                          Copy
                        </span>
                      </div>
