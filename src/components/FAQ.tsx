...
const faqs = [
  { q: "How does RepurposeHub adapt content for different platforms?", a: "Our AI analyzes the unique requirements of each platform — character limits, formatting rules, audience expectations, and engagement best practices. It then rewrites your content to match the optimal tone, structure, and format for each platform while maintaining your core message and style." },
  { q: "What are Custom Instructions?", a: "Custom Instructions let you set your preferred tone, target audience, and style for all your generations. For example: 'write in casual tone, target startup founders, always include a CTA'. Your instructions are saved and applied automatically to every generation." },
