...
const faqs = [
  ...
  { q: "Which platforms are supported?", a: "We currently support 12 platforms: Twitter/X, LinkedIn, Instagram, YouTube, Email newsletters, Telegram, Reddit, Medium, TikTok, Substack, Threads, and Pinterest." },
