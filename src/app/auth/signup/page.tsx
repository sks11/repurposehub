...
import { Zap, Mail, Eye, EyeOff, Check } from "lucide-react";
    ...
    <div className="min-h-screen flex items-center justify-center bg-surface px-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-muted mt-2">Start repurposing your content for free</p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-border/60 shadow-lg p-8">
          ...
          <div className="flex items-center gap-4 my-6">
            <div className="flex-1 h-px bg-border" /><span className="text-xs text-muted font-medium">OR</span><div className="flex-1 h-px bg-border" />
          </div>
          ...
          <div className="mt-6 space-y-2">
            {["30 free generations / month", "All 12 platforms included", "No credit card required"].map((item) => (
        ...
        <p className="text-center text-sm text-muted mt-6">
          ...
          <a href="/auth/signin" className="text-primary font-semibold hover:underline">Sign in</a>
        </p>
      </div>
    </div>
  );
